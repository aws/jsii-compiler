        ...
        steps: [
          {
            ...
            run: [
              ...
              '  "---------|--------:|--------:|--------:|-------:|--------:",',
              '];',
              'const ms = new Intl.NumberFormat("en-US", { style: "unit", unit: "duration-millisecond", maximumFractionDigits: 1, minimumFractionDigits: 1 });',
              ...
              '  summary.push([compiler, ms.format(min), ms.format(avg), ms.format(max), dec.format(stddev), dec.format(avg / fastest) + "x"].join(" | "));',
              '}',
              'summary.push("");',
              '',
