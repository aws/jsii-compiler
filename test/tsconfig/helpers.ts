...
export function fcTsconfig(
  ...
  const compilerOptionsModel: RecordModel<Required<ts.CompilerOptions>> = {
    ...
    baseUrl: fc.oneof(fc.string(), fc.constant(undefined)) as fc.Arbitrary<string>,
    charset: fc.string(),
    checkJs: fc.boolean(),
    ...
    downlevelIteration: fc.oneof(fc.boolean(), fc.constant(undefined)) as fc.Arbitrary<boolean>,
    emitBOM: fc.boolean(),
    ...
    out: fc.string(),
    outDir: fc.string(),
    outFile: fc.oneof(fc.string(), fc.constant(undefined)) as fc.Arbitrary<string>,
